...
create database if not exists pfa DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
use pfa;
...
insert into modules(title) value('Microservico: Catalogo de Videos com Laravel (Backend)');
insert into modules(title) value('Microservico: Catalogo de Videos com React (Front-End)');
insert into modules(title) value('Microservico API do Catalogo com Node.JS (Backend)');
insert into modules(title) value('Microservico - Aplicacao do Assinante com React.JS (Front-end) (Em Breve)');
insert into modules(title) value('Autenticacao entre Microservicos');
insert into modules(title) value('Microservico - Assinatura com Django (Backend) - (em breve)');
